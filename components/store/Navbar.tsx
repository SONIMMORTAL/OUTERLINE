    ...
    <>
      ...
      >
        ...
        <div className={`w-full transition-all duration-300 ${
          ...
          {/* Mobile / Tablet Menu Button — the five desktop links need ~860px, so tablets use the menu */}
          ...
          <div className="hidden lg:flex items-center gap-8 xl:gap-12">
            {NAV_LINKS.map((link) => (
              <Link
                key={link.name}
                href={link.href}
                className="whitespace-nowrap uppercase tracking-widest text-xs text-[#666666] hover:text-[#0A192F] transition-colors relative group"
              >
                {link.name}
